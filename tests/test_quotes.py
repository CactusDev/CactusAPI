...
class TestQuotes:
    ...
    # def test_single(self, client, app):
    #     """Get a single quote object and see if it matches"""
    #
    #     quote = client.post(self.url, data=self.creation_data[0],
    #                         environ_base={
    #                             "X-Auth-Key": app.config["API_KEY"],
    ...
    #     # Add a quote to remove
    #     # Remove the quote
    #     # Compare the IDs to see if they match
